...
myKeys conf@(XConfig {XMonad.modMask = modm}) = M.fromList $
    ...
    -- brightness
    , ((0,                  0x1008ff02), spawn "bash ~/.xmonad/brightness.sh +")
    , ((0,                  0x1008ff03), spawn "bash ~/.xmonad/brightness.sh -")

    -- screenshot
    , ((0,                  0xff61), spawn "spectacle")

    -- shutdown
    , ((modm .|. shiftMask, xK_x), spawn "shutdown now")
    , ((modm .|. shiftMask, xK_z), spawn "reboot")
